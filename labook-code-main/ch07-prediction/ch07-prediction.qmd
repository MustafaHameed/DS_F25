...
```{r}
events = import("E:/Documents/Github/DS_F25/data-main/1_moodleLAcourse/Events.xlsx")
```
...
```{r}
results = rio::import("E:/Documents/Github/DS_F25/data-main/1_moodleLAcourse/Results.xlsx")
```
